...
$order_id = $_GET['id'];
$sql5 = "SELECT OrderID, OrdertypeID, CustomerID, SupplierID, ProductID, Price, Quantity FROM orders WHERE OrderID = ? AND StoreID = ?";
...
<div class="container content">
    ...
    <div class="row justify-content-center">
        ...
        <div class="form-wrap ">
            <form id="survey-form" method="post" action="edit-order-response.php">
                <div class="row">
                            ...
                            <select id="ordertype-selection" name="ordertype-selection" class="form-control" required>
                                ...
                                if ($result1->num_rows > 0) {
                                    while ($row = $result1->fetch_assoc()) {
                                        if ($row['OrdertypeID'] == $order['OrdertypeID']) {
                                            echo "<option value='" . $row["OrdertypeID"] . "' selected>" . $row["Name"] . "</option>";
                                        } else {
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="price" id="price" value="<?php echo $order['Price']; ?>"
